 ...
 *
 * @author makejava
 * @since 2021-02-03 15:20:16
 */
@Repository
public interface AccountDao
{

    Account selectByAccountNameAndPassword(@Param("accountName") String accountName,@Param("password") String password);
